...
var todoList = ['default item']; //our todo list array
...
router.get('/api/get/:id', function (req, res) {
	res.json(todoList[req.params.id]); //Notice the wildcard in the URL? Try browsing to /api/get/0 once you've added some entries
});
